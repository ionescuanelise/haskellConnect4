...
depthFirstSearch g destination next [] [] = depthFirstSearch g destination next [[0]] []
depthFirstSearch g destination next branches exploredList = 
                                    let y = head branches
                                        x = head y
                                        bool = checkArrival x destination
                                        ans = explored x exploredList
                                    in if bool == True then Just
                                       else if ans == False then depthFirstSearch g destination next ((next y g) ++ branches) (x:exploredList)
                                       else depthFirstSearch g destination next (tail branches) exploredList
